...
export default {
    ...
    CylinderBufferGeometry: function (mesh) {
        ...
        function generateGeometry() {
            ...
            updateGroupGeometry(mesh,
                new THREE.THREE.CylinderBufferGeometry(
                    data.radiusTop,
                    data.radiusBottom,
                    data.height,
                    data.radialSegments,
    ...
    ParametricBufferGeometry: function (mesh) {
        ...
        function generateGeometry() {
            ...
            updateGroupGeometry(mesh,
                new THREE.ParametricBufferGeometry(ParametricGeometries.klein, data.slices, data.stacks)
            );
    ...
    ParametricGeometry: function (mesh) {
        ...
        function generateGeometry() {
            ...
            updateGroupGeometry(mesh,
                new THREE.ParametricGeometry(ParametricGeometries.klein, data.slices, data.stacks)
            );
